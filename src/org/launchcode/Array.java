...
public class Array {
    ...
    public static void loadArray() {
        ...
        nam.add(new Adult("Simon Heron", "37", "Working for Coles", "Image4", "Sid Simon", "Eve and Steve Heron", "Evan"));
        nam.add(new Adult("Joanne Heron", "34", "Unemployed", "none", "Mary Simon", "Michelle and Bob Jip", "Evan"));
        ...
        nam.add(new Adult("Maggie Evans", "43", "Working for IBM", "Image1", "Jo MacRay", "Simon and Rita Evans", "Bre"));
        ...
        nam.add(new Adult("John Simon", "44", "Working at IBM", "Image5", "Cisco Draper", "Justine and Roy Simon", "Sid and Lucy"));
        nam.add(new Adult("Mary Simon", "42", "Accountant", "Image3", "Joanne Heron", "Paul and Ivy MacRay", "Sid and Lucy"));
        nam.add(new Children("Sid Simon", "3", "Accountant", "Image3", "Joanne Heron", "John  and Mary Simon", "none"));
